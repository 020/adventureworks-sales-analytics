...
A end-to-end data analytics project demonstrating the full pipeline from raw data through cleaning, analysis, and interactive dashboard development — with predictive analytics and machine learning planned as the next phase.
